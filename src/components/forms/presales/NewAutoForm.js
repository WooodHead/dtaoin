...
class NewAutoForm extends BaseAutoComponent {
  ...
  getIntentionAutoDetail() {
    api.ajax({url: api.getIntentionAutoInfo(this.props.customer_id, this.props.intention_id)}, function (data) {
      ...
      if (intention) {
        ...
        this.props.onSuccess({auto_id: intention._id});
  ...
  render() {
    ...
    return (
      <Form horizontal>
        {getFieldDecorator('_id', {initialValue: this.props.auto_id})(
          <Input type="hidden"/>
        )}
        {getFieldDecorator('customer_id', {initialValue: this.props.customer_id})(
          <Input type="hidden"/>
        )}
        {getFieldDecorator('intention_id', {initialValue: this.props.intention_id})(
          <Input type="hidden"/>
        )}
        ...
        <FormItem label="内饰" {...formItemLayout}>
          {getFieldDecorator('in_color', {initialValue: auto.in_color || '-1'})(
            <Select{...selectStyle}>
