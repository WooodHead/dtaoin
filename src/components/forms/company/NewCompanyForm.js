...
class NewCompanyForm extends UploadComponent {
  constructor(props) {
    super(props);
    this.state = {
      provinces: [],
        ...
        <Row type="flex">
          <Col span="24">
            <FormItem label="门店地址" {...formItem12} labelCol={{span: 2}} wrapperCol={{span: 21}} required>
              <Input {...getFieldProps('address')} placeholder="请输入门店地址"/>
            </FormItem>
          </Col>
        </Row>
        <Row type="flex">
        ...
        <Row type="flex">
          <Col span="12">
            <FormItem label="店总负责人" {...formItemTwo} labelCol={{span: 4}} wrapperCol={{span: 19}} required>
              <Input {...getFieldProps('admin_name')} placeholder="请输入店总负责人"/>
            </FormItem>
          </Col>
          <Col span="12">
        ...
        <Row type="flex">
          <Col span="12">
            <FormItem label="其他联系人" {...formItemTwo} labelCol={{span: 4}} wrapperCol={{span: 19}}>
              <Input {...getFieldProps('other_name')} placeholder="请输入其他联系人"/>
            </FormItem>
          </Col>
          <Col span="12">
        ...
        <Row type="flex">
          ...
          <Col span="8">
            <FormItem label="营业时间" {...formItemTwo} labelCol={{span: 6}} wrapperCol={{span: 18}}>
              <TimePicker {...getFieldProps('service_start_time', {initialValue: '07:30'})} disabledMinutes={this.disabledMinutes.bind(this)} hideDisabledOptions format="HH:mm"/>
              -
              <TimePicker {...getFieldProps('service_end_time', {initialValue: '17:30'})} disabledMinutes={this.disabledMinutes.bind(this)} hideDisabledOptions format="HH:mm"/>
            </FormItem>
          </Col>
          <Col span="8">
            <FormItem label="在App展示" labelCol={{span: 6}} wrapperCol={{span: 16}}>
              <RadioGroup {...getFieldProps('is_show_on_app', {initialValue: 0})}>
        ...
        <Row type="flex">
          <Col span="24">
            <FormItem label="开户银行" {...formItem12} labelCol={{span: 2}} wrapperCol={{span: 21}}>
              <Input {...getFieldProps('bank_name')} placeholder="请输入门店开户银行及支行信息"/>
            </FormItem>
          </Col>
        </Row>
        ...
        <Row type="flex">
          <Col span="12">
            <FormItem label="银行卡户主" {...formItemTwo} labelCol={{span: 4}} wrapperCol={{span: 19}}>
              <Input {...getFieldProps('bank_account_name')} placeholder="请输入银行卡户主"/>
            </FormItem>
          </Col>
          <Col span="12">
            <FormItem label="银行卡卡号" {...formItemTwo} labelCol={{span: 4}} wrapperCol={{span: 18}}>
              <Input {...getFieldProps('bank_account_number')} placeholder="请输入银行卡卡号"/>
            </FormItem>
          </Col>
        </Row>
...
NewCompanyForm = Form.create()(NewCompanyForm);
