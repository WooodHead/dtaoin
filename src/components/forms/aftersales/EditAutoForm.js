  ...
  render() {
    ...
    return (
      <Form horizontal>
        ...
        {getFieldDecorator('customer_id', {initialValue: auto.customer_id})(
          <Input type="hidden"/>
        )}
        ...
        <FormItem label="车型名称" {...formItemLayout}>
          {getFieldDecorator('auto_type_name', {initialValue: autoTypeName})(
        ...
        <FormItem label="车牌号" {...formItemLayout}>
          {getFieldDecorator('plate_num', {
            ...
            rules: [{
              required: true, message: validator.required.plateNumber
            }, {
