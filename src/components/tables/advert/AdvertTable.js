...
import NewAdvert from '../../modals/advert/NewAdvert'
import EditAdvert from '../../modals/advert/EditAdvert'
import OfflineAdvert from '../../modals/advert/OfflineAdvert'

export default class AdvertTable extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tableData: [],
