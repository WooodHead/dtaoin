...
export default class ProjectPrintDispatch extends PrintThisComponent {
  ...
  handlePrint(e) {
    ...
    this.printThis({
      ...
      pageTitle: USER_SESSION.brand_name + '-' + USER_SESSION.company_name + '-派工单',               //add title to print page
      removeInline: false,         //remove all inline styles from print elements
      printDelay: 333,            // variable print delay
      header: '<h2 style="text-align:center">' + USER_SESSION.brand_name + '-' + USER_SESSION.company_name + '-派工单</h2>',               // prefix to body
  ...
  render() {
    ...
    return (
      <div>
        <h3 className="center">{USER_SESSION.brand_name}-{USER_SESSION.company_name}-派工单</h3>
