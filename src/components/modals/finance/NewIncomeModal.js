...
import NewIncomeType from '../../popover/NewIncomeType';
...
class NewIncomeModal extends BaseModal {
  ...
  getIncomeTypes(newTypeId) {
    api.ajax({url: api.getProjectTypeList(0)}, function (data) {
  ...
  render() {
    ...
    return (
      <span>
        ...
        <Modal
          title={<span><Icon type="plus" className="margin-right-10"/>新增收入</span>}
          visible={visible}
          width="680px"
