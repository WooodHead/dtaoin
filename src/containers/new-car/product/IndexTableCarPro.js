...
import { Input, Cascader, Row, Select, Col, Button,Spin } from 'antd';
import { bindActionCreators } from 'redux';
import { connect } from 'react-redux';
import BaseList from '../../../components/base/BaseList_';
import Table from './TableIntention';

class IndexTableCarPro extends BaseList {
  componentDidMount() {}
  ...
  render() {
    const { isFetching, getMarketListData, getMarketProAllListData ,getProductDetailRes, page } = this.props;
...
export default IndexTableCarPro;
