...
import Table from './TableMaintenance';

const Option = Select.Option;

export default class ListMaintenance extends BaseList {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    let {dueData, status, page, reload} = this.state;
    return (
      <div>
        <Row className="mb15">
          <Col span={24}>
        ...
        <Table
          page={page}
          source={api.task.getMaintenanceList(dueData, status, page)}
