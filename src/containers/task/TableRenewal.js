...
export default class TableRenewal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      list: [],
    ...
    const columns = [
      {
        ...
        key: 'dueExpire',
        className: 'center',
        render: (value, record) => self.dueExpire(record.force_expire_date) + '日',
      }, {
        title: '交强险到期',
        ...
        className: 'center',
        render: (value, record) => (
          <TaskModal record={record} task_type="insurance" handleChangeData={self.handleChangeData}/>
        ),
      }];
