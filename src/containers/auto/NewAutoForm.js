...
class NewAutoForm extends BaseAutoComponent {
  ...
  getCustomerAutos(customerId) {
    api.ajax({url: api.presales.userAutoList(customerId)}, function (data) {
            ...
            if (newAuto) {
              return (
                <span>
                  ...
                  <Button size="large" type="primary" onClick={this.handleSubmit.bind(this)}>保存</Button>
                </span>
              );
            } else {
              return (
                <span>
                  ...
                  <Button size="large" type="primary" className="mr15" onClick={this.handleNextStep}>下一步</Button>
