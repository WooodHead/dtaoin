...
import DiscountTable from '../benefit/tables/CountTable'
...
export default class Timecount extends Component {
  ...
  //当状态变更时候会变换
  handleSelect(value) {
    this.setState({condition: Object.assign(this.state.condition, {status: value})}, () => {
      this.getList();
    });
  }
        ...
        <Row className="mb15">
          <Col span="9">
            ...
            <HCSearchSelectBox
              ...
              displayPattern={(item)=>{return item.name + '-----' + item.remark;}}
              autoSearch={true}
              onSelectItem={(value) => {
          ...
          <Col span="5">
            <span className="pull-right">
              <Button type="primary" size="large">
                <Link to="/marketing/discount/createDiscount">创建折扣</Link>
              </Button>
            </span>
          </Col>
        </Row>
