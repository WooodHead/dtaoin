...
function StringCreate(realm, value, prototype) {
  ...
  (0, _properties.DefinePropertyOrThrow)(realm, S, "length", {
...
function ArraySpeciesCreate(realm, originalArray, length) {
  ...
  return (0, _construct.Construct)(realm, C, [new _index.NumberValue(realm, length)]);
}
...
function ArrayCreate(realm, length, proto) {
  ...
  (0, _properties.OrdinaryDefineOwnProperty)(realm, A, "length", {
    value: new _index.NumberValue(realm, length),
    writable: true,
    enumerable: false,
    configurable: false
...
function CreateUnmappedArgumentsObject(realm, argumentsList) {
  ...
  (0, _properties.DefinePropertyOrThrow)(realm, obj, "length", {
  ...
  (0, _properties.DefinePropertyOrThrow)(realm, obj, realm.intrinsics.SymbolIterator, {
  ...
  (0, _properties.DefinePropertyOrThrow)(realm, obj, "callee", {
...
function CreateDynamicFunction(realm, constructor, newTarget, kind, args) {
  ...
  var F = (0, _function.FunctionAllocate)(realm, proto, strict, kind);
  ...
  (0, _function.FunctionInitialize)(realm, F, "normal", params, body, scope);
  ...
  (0, _function.SetFunctionName)(realm, F, "anonymous");
