...
function RegExpAlloc(realm, newTarget) {
  ...
  (0, _properties.DefinePropertyOrThrow)(realm, obj, "lastIndex", {
    writable: true,
    enumerable: false,
    configurable: false
  });
...
function RegExpInitialize(realm, obj, pattern, flags) {
  ...
  (0, _properties.Set)(realm, obj, "lastIndex", realm.intrinsics.zero, true);
...
function RegExpBuiltinExec(realm, R, S) {
  ...
  while (!matchSucceeded) {
    ...
    if (lastIndex > length) {
      ...
      (0, _properties.Set)(realm, R, "lastIndex", realm.intrinsics.zero, true);
      // ii. Return null.
  ...
  if (global === true || sticky === true) {
    ...
    (0, _properties.Set)(realm, R, "lastIndex", new _index.NumberValue(realm, e), true);
  }
