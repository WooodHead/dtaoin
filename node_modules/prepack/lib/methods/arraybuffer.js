...
function AllocateArrayBuffer(realm, constructor, byteLength) {
  ...
  var obj = (0, _create.OrdinaryCreateFromConstructor)(realm, constructor, "ArrayBufferPrototype", {
...
function DetachArrayBuffer(realm, arrayBuffer) {
  ...
  (0, _properties.ThrowIfInternalSlotNotWritable)(realm, arrayBuffer, "$ArrayBufferData").$ArrayBufferData = null;

  // 3. Set arrayBuffer.[[ArrayBufferByteLength]] to 0.
  (0, _properties.ThrowIfInternalSlotNotWritable)(realm, arrayBuffer, "$ArrayBufferByteLength").$ArrayBufferByteLength = 0;
...
function GetViewValue(realm, view, requestIndex, isLittleEndian, type) {
  ...
  var getIndex = (0, _to.ToIndexPartial)(realm, requestIndex);

  // 5. Let littleEndian be ToBoolean(isLittleEndian).
  var littleEndian = (0, _to.ToBooleanPartial)(realm, isLittleEndian);
...
function SetViewValue(realm, view, requestIndex, isLittleEndian, type, value) {
  ...
  var numberValue = (0, _to.ToNumber)(realm, value);
...
function SetValueInBuffer(realm, arrayBuffer, byteIndex, type, value, isLittleEndian) {
  ...
  var block = (0, _properties.ThrowIfInternalSlotNotWritable)(realm, arrayBuffer, "$ArrayBufferData").$ArrayBufferData;
  ...
  if (type === "Float32") {
    ...
    var convOp = _to.ElementConv[type];
