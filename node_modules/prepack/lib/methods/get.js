...
function GetFunctionRealm(realm, obj) {
  ...
  (0, _invariant2.default)((0, _index3.IsCallable)(realm, obj), "expected callable object");
  ...
  if (obj instanceof _index2.BoundFunctionValue) {
  ...
  if (obj instanceof _index2.ProxyValue) {
    ...
    if (obj.$ProxyHandler instanceof _index2.NullValue) {
      throw realm.createErrorThrowCompletion(realm.intrinsics.TypeError, "proxy handler is null");
    }
    (0, _invariant2.default)(obj.$ProxyTarget instanceof _index2.ObjectValue);
...
function OrdinaryGet(realm, O, P, Receiver, dataOnly) {
  ...
  (0, _invariant2.default)((0, _index3.IsPropertyKey)(realm, P), "expected property key");
  ...
  if (!desc || descValue.mightHaveBeenDeleted()) {
    ...
    if (descValue.mightHaveBeenDeleted()) {
      ...
      (0, _invariant2.default)(descValue instanceof _index2.AbstractValue);
      var parentVal = OrdinaryGet(realm, parent, P, descValue, true);
      if (parentVal instanceof _index2.UndefinedValue)
      ...
      var cond = realm.createAbstract(new _index.TypesDomain(_index2.BooleanValue), _index.ValuesDomain.topVal, [descValue, realm.intrinsics.empty], function (_ref) {
      ...
      return (0, _index3.joinValuesAsConditional)(realm, cond, descValue, parentVal);
    }
  ...
  if ((0, _index3.IsDataDescriptor)(realm, desc)) return descValue;
  if (dataOnly) {
    (0, _invariant2.default)(descValue instanceof _index2.AbstractValue);
    _index2.AbstractValue.reportIntrospectionError(descValue);
    throw new _errors.FatalError();
  }

  // 5. Assert: IsAccessorDescriptor(desc) is true.
  (0, _invariant2.default)((0, _index3.IsAccessorDescriptor)(realm, desc), "expected accessor descriptor");

  // 6. Let getter be desc.[[Get]].
  var getter = desc.get;

  // 7. If getter is undefined, return undefined.
  if (!getter || getter instanceof _index2.UndefinedValue) return realm.intrinsics.undefined;

  // 8. Return ? Call(getter, Receiver).
  return (0, _index3.Call)(realm, getter, Receiver);
}
...
function GetMethod(realm, V, P) {
  ...
  if ((0, _index3.HasSomeCompatibleType)(func, _index2.NullValue, _index2.UndefinedValue)) {
    return realm.intrinsics.undefined;
  }

  // 4. If IsCallable(func) is false, throw a TypeError exception.
  if (!(0, _index3.IsCallable)(realm, func)) {
...
function GetPrototypeFromConstructor(realm, constructor, intrinsicDefaultProto) {
  ...
  (0, _invariant2.default)((0, _index3.IsCallable)(realm, constructor) === true, "expected constructor to be callable");

  // 3. Let proto be ? Get(constructor, "prototype").
  var proto = Get(realm, constructor, new _index2.StringValue(realm, "prototype"));

  // 4. If Type(proto) is not Object, then
  if (!(proto instanceof _index2.ObjectValue)) {
...
function Get(realm, O, P) {
  ...
  (0, _invariant2.default)(O instanceof _index2.ObjectValue || O instanceof _index2.AbstractObjectValue, "Not an object value");

  // 2. Assert: IsPropertyKey(P) is true.
  (0, _invariant2.default)((0, _index3.IsPropertyKey)(realm, P), "Not a valid property key");
...
function GetV(realm, V, P) {
  ...
  var O = (0, _index3.ToObjectPartial)(realm, V);
...
function GetThisValue(realm, V) {
  ...
  (0, _invariant2.default)((0, _index3.IsPropertyReference)(realm, V), "expected property reference");

  // 2. If IsSuperReference(V) is true, then
  if ((0, _index3.IsSuperReference)(realm, V)) {
  ...
  // 3. Return GetBase(V).
  var result = (0, _index3.GetBase)(realm, V);
...
function GetNewTarget(realm) {
  ...
  var envRec = (0, _index3.GetThisEnvironment)(realm);
...
function GetTemplateObject(realm, templateLiteral) {
  ...
  while (index < count) {
    ...
    var prop = (0, _to.ToString)(realm, new _index2.NumberValue(realm, index));

    // b. Let cookedValue be the String value cookedStrings[index].
    var cookedValue = new _index2.StringValue(realm, cookedStrings[index]);
    ...
    var rawValue = new _index2.StringValue(realm, rawStrings[index]);
