...
exports.IteratorBindingInitialization = IteratorBindingInitialization;
...
function HasPrimitiveBase(realm, V) {
  ...
  if (base instanceof _index.ObjectValue || base instanceof _index.AbstractObjectValue) return false;
...
function IsPropertyReference(realm, V) {
  ...
  return V.base instanceof _index.AbstractValue || V.base instanceof _index.ObjectValue || HasPrimitiveBase(realm, V);
}
...
function BindingInitialization(realm, node, value, strictCode, environment) {
...
// ECMA262 13.3.3.6
// ECMA262 14.1.19
function IteratorBindingInitialization(realm, formals, iteratorRecord, strictCode, environment) {
  var env = environment ? environment : realm.getRunningContext().lexicalEnvironment;
  ...
  try {
    for (var _iterator8 = formals[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
      ...
      if (param.type === "Identifier") {
        ...
        var _lhs = ResolveBinding(realm, param.name, strictCode, environment);
        ...
        if (Initializer && v instanceof _index.UndefinedValue) {
          ...
          if ((0, _index2.IsAnonymousFunctionDefinition)(realm, Initializer) && v instanceof _index.ObjectValue) {
            ...
            if (hasNameProperty === false) {
              (0, _index2.SetFunctionName)(realm, v, bindingId);
            }
          }
        }
        ...
        if (!environment) {
          (0, _index2.PutValue)(realm, _lhs, v);
          continue;
        }

        // 7. Return InitializeReferencedBinding(lhs, v).
        InitializeReferencedBinding(realm, _lhs, v);
        continue;
      } else {
        ...
        if (Initializer && _v instanceof _index.UndefinedValue) {
          ...
          // b. Let v be ? GetValue(defaultValue).
          _v = GetValue(realm, _defaultValue);
        }

        // 4. Return the result of performing BindingInitialization of BindingPattern with v and environment as the arguments.
        BindingInitialization(realm, param, _v, strictCode, environment);
        continue;
      }
    }
  ...
  if (restEl && restEl.argument.type === "Identifier") {
    ...
    var lhs = ResolveBinding(realm, restEl.argument.name, strictCode, environment);
    ...
    while (true) {
      ...
      if (iteratorRecord.$Done === true) {
        ...
        if (!environment) {
          (0, _index2.PutValue)(realm, lhs, A);
          break;
        }
    ...
    while (true) {
      ...
      if (iteratorRecord.$Done === true) {
        ...
        BindingInitialization(realm, restEl.argument, _A, strictCode, environment);
        break;
      }
...
// ECMA262 13.3.3.7
function KeyedBindingInitialization(realm, node, value, strictCode, environment, propertyName) {
  var env = environment ? environment : realm.getRunningContext().lexicalEnvironment;
  ...
  if (node.type === "Identifier") {
    ...
    // 2. Let lhs be ? ResolveBinding(bindingId, environment).
    var lhs = ResolveBinding(realm, bindingId, strictCode, environment);
