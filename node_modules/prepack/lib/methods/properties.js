...
// ECMA 14.3.9
function PropertyDefinitionEvaluation(realm, MethodDefinition, object, env, strictCode, enumerable) {
  // MethodDefinition : PropertyName ( StrictFormalParameters ) { FunctionBody }
  if (MethodDefinition.kind === "method") {
    // 1. Let methodDef be DefineMethod of MethodDefinition with argument object.
    var methodDef = (0, _index2.DefineMethod)(realm, MethodDefinition, object, env, strictCode);
    ...
    var closure = (0, _index2.GeneratorFunctionCreate)(realm, "method", MethodDefinition.params, MethodDefinition.body, scope, strict);

    // 6. Perform MakeMethod(closure, object).
    (0, _index2.MakeMethod)(realm, closure, object);
    ...
    (0, _index2.SetFunctionName)(realm, closure, propKey);
    ...
    return DefinePropertyOrThrow(realm, object, propKey, _desc);
    ...
    var _closure = (0, _index2.FunctionCreate)(realm, "method", formalParameterList, MethodDefinition.body, _scope, _strict);

    // 7. Perform MakeMethod(closure, object).
    (0, _index2.MakeMethod)(realm, _closure, object);

    // 8. Perform SetFunctionName(closure, propKey, "get").
    (0, _index2.SetFunctionName)(realm, _closure, _propKey, "get");
    ...
    DefinePropertyOrThrow(realm, object, _propKey, _desc2);
    ...
    var _closure2 = (0, _index2.FunctionCreate)(realm, "method", MethodDefinition.params, MethodDefinition.body, _scope2, _strict2);

    // 6. Perform MakeMethod(closure, object).
    (0, _index2.MakeMethod)(realm, _closure2, object);

    // 7. Perform SetFunctionName(closure, propKey, "set").
    (0, _index2.SetFunctionName)(realm, _closure2, _propKey2, "set");
    ...
    DefinePropertyOrThrow(realm, object, _propKey2, _desc3);
  }
}
