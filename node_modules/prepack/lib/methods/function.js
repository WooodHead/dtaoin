...
exports.FindVarScopedDeclarations = FindVarScopedDeclarations;
...
exports.EvaluateStatements = EvaluateStatements;
exports.PartiallyEvaluateStatements = PartiallyEvaluateStatements;
...
var _environment2 = require("../methods/environment.js");

var _index4 = require("../methods/index.js");
...
function FindVarScopedDeclarations(ast_node) {
...
// ECMA262 9.2.12
function FunctionDeclarationInstantiation(realm, func, argumentsList) {
  ...
  try {
    for (var _iterator5 = formals[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
      var _param2 = _step5.value;

      if ((0, _index4.ContainsExpression)(realm, _param2)) {
  ...
  var varDeclarations = FindVarScopedDeclarations(code);
  ...
  try {
    for (var _iterator6 = varDeclarations.reverse()[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
      var d = _step6.value;
      ...
      if (d.type !== "VariableDeclaration") {
        ...
        var fn = (0, _index4.BoundNames)(realm, d)[0];
  ...
  try {
    for (var _iterator7 = parameterNames[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
      var paramName = _step7.value;
  ...
  if (hasDuplicates === true) {
    ...
    (0, _invariant2.default)(formals !== undefined);
    (0, _environment2.IteratorBindingInitialization)(realm, formals, iteratorRecord, strict);
  } else {
    // 25. Else,
    // a. Perform ? IteratorBindingInitialization for formals with iteratorRecord and env as arguments.
    (0, _invariant2.default)(formals !== undefined);
    (0, _environment2.IteratorBindingInitialization)(realm, formals, iteratorRecord, strict, env);
  }
  ...
  if (hasParameterExpressions === false) {
    ...
    try {
      for (var _iterator8 = varNames[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
        var n = _step8.value;
    ...
    varEnv = (0, _index3.NewDeclarativeEnvironment)(realm, env);
    ...
    try {
      for (var _iterator9 = varNames[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
        var _n = _step9.value;
  ...
  if (strict === false) {
    ...
    lexEnv = (0, _index3.NewDeclarativeEnvironment)(realm, varEnv);
  ...
  try {
    for (var _iterator10 = lexDeclarations[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
      ...
      try {
        for (var _iterator12 = (0, _index4.BoundNames)(realm, _d)[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
          var dn = _step12.value;
  ...
  try {
    for (var _iterator11 = functionsToInitialize[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
      var f = _step11.value;

      // a. Let fn be the sole element of the BoundNames of f.
      var fn = (0, _index4.BoundNames)(realm, f)[0];
      // b. Let fo be the result of performing InstantiateFunctionObject for f with argument lexEnv.
      var fo = lexEnv.evaluate(f, strict);
      (0, _invariant2.default)(fo instanceof _index2.Value);
...
// ECMA262 9.2.11
function SetFunctionName(realm, F, name, prefix) {
  ...
  (0, _invariant2.default)(typeof name === "string" || name instanceof _index2.StringValue || name instanceof _index2.SymbolValue || name instanceof _index2.AbstractValue, "expected name to be a string or symbol");
  if (typeof name === "string") name = new _index2.StringValue(realm, name);
  ...
  if (name instanceof _index2.SymbolValue) {
    ...
    if (description === undefined) {
      ...
      (0, _invariant2.default)(description instanceof _index2.Value);
      name = new _index2.StringValue(realm, "[" + description.throwIfNotConcreteString().value + "]");
    }
  }
  ...
  if (prefix) {
    ...
    if (name instanceof _index2.AbstractValue) {
      var prefixVal = new _index2.StringValue(realm, prefix + " ");
      name = realm.createAbstract(new _index.TypesDomain(_index2.StringValue), _index.ValuesDomain.topVal, [prefixVal, name], function (_ref) {
        var _ref2 = _slicedToArray(_ref, 2),
            lnode = _ref2[0],
            rnode = _ref2[1];

        return t.binaryExpression("+", lnode, rnode);
      });
    } else {
      name = new _index2.StringValue(realm, prefix + " " + name.value);
    }
  }

  // 6. Return ! DefinePropertyOrThrow(F, "name", PropertyDescriptor{[[Value]]: name, [[Writable]]: false, [[Enumerable]]: false, [[Configurable]]: true}).
  return (0, _index3.DefinePropertyOrThrow)(realm, F, "name", {
    value: name,
    enumerable: false,
    writable: false,
    configurable: true
...
// ECMA262 9.2.3
function FunctionInitialize(realm, F, kind, ParameterList, Body, Scope) {
  ...
  try {
    for (var _iterator13 = ParameterList[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
      var FormalParameter = _step13.value;
  ...
  (0, _index3.DefinePropertyOrThrow)(realm, F, "length", {
    value: new _index2.NumberValue(realm, len),
    writable: false,
    enumerable: false,
    configurable: true
  });
  ...
  F.$ScriptOrModule = (0, _index4.GetActiveScriptOrModule)(realm);
...
// ECMA262 9.2.6
function GeneratorFunctionCreate(realm, kind, ParameterList, Body, Scope, Strict) {
  ...
  var F = FunctionAllocate(realm, functionPrototype, Strict, "generator");
...
function AddRestrictedFunctionProperties(F, realm) {
  ...
  return (0, _index3.DefinePropertyOrThrow)(realm, F, "arguments", desc);
}

// ECMA262 9.2.1
function $Call(realm, F, thisArgument, argsList) {
...
function InternalCall(realm, F, thisArgument, argsList, tracerIndex) {
  ...
  (0, _invariant2.default)(F instanceof _index2.FunctionValue, "expected function value");
  ...
  var _loop = function _loop() {
    ...
    if (detourResult instanceof _index2.Value) return {
        v: detourResult
      };
  };
  ...
  try {
    ...
    try {
      for (var _iterator14 = realm.tracers[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
        var t1 = _step14.value;
    ...
    if (calleeContext.savedCompletion !== undefined) {
      if (callerContext.savedCompletion !== undefined) callerContext.savedCompletion = (0, _index4.composePossiblyNormalCompletions)(realm, callerContext.savedCompletion, calleeContext.savedCompletion);else callerContext.savedCompletion = calleeContext.savedCompletion;
    ...
    try {
      for (var _iterator15 = realm.tracers[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
        var t2 = _step15.value;
  ...
  if (result instanceof _completions.JoinedAbruptCompletions) {
    result = (0, _index4.joinAndRemoveNestedReturnCompletions)(realm, result);
  }
...
function InternalConstruct(realm, F, argumentsList, newTarget, thisArgument, tracerIndex) {
  // 1. Assert: F is an ECMAScript function object.
  (0, _invariant2.default)(F instanceof _index2.FunctionValue, "expected function");

  // 2. Assert: Type(newTarget) is Object.
  (0, _invariant2.default)(newTarget instanceof _index2.ObjectValue, "expected object");
  ...
  var _loop2 = function _loop2() {
    ...
    if (detourResult instanceof _index2.ObjectValue) return {
        v: detourResult
      };
  ...
  try {
    ...
    try {
      for (var _iterator16 = realm.tracers[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
        var t1 = _step16.value;
    ...
    try {
      for (var _iterator17 = realm.tracers[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
        var t2 = _step17.value;
  ...
  (0, _invariant2.default)(envRecThisBinding instanceof _index2.ObjectValue);
  return envRecThisBinding;
}

// ECMA262 9.2.3
function FunctionAllocate(realm, functionPrototype, strict, functionKind) {
  // 1. Assert: Type(functionPrototype) is Object.
  (0, _invariant2.default)(functionPrototype instanceof _index2.ObjectValue, "expected functionPrototype to be an object");
  ...
  var F = new _index2.ECMAScriptSourceFunctionValue(realm);
...
// ECMA262 9.4.1.3
function BoundFunctionCreate(realm, targetFunction, boundThis, boundArgs) {
  // 1. Assert: Type(targetFunction) is Object.
  (0, _invariant2.default)(targetFunction instanceof _index2.ObjectValue, "expected an object");

  // 2. Let proto be ? targetFunction.[[GetPrototypeOf]]().
  var proto = targetFunction.$GetPrototypeOf();

  // 3. Let obj be a newly created object.
  var obj = new _index2.BoundFunctionValue(realm);
...
function PerformEval(realm, x, evalRealm, strictCaller, direct) {
  ...
  if (direct) {
    ...
    lexEnv = (0, _index3.NewDeclarativeEnvironment)(realm, ctx.lexicalEnvironment);
    ...
    lexEnv = (0, _index3.NewDeclarativeEnvironment)(realm, evalRealm.$GlobalEnv);
  ...
  try {
    ...
    (0, _invariant2.default)(result instanceof _index2.Value || result instanceof _completions.AbruptCompletion);
      ...
      if (script.directives) {
        ...
        try {
          for (var _iterator18 = script.directives[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
            ...
            result = new _index2.StringValue(realm, directive.value.value);
          }
        } catch (err) {
    ...
    if (result instanceof _index2.EmptyValue) {
...
function EvaluateStatements(body, blockValue, strictCode, blockEnv, realm) {
  ...
  try {
    for (var _iterator19 = body[Symbol.iterator](), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
      ...
      if (node.type !== "FunctionDeclaration") {
        var res = blockEnv.evaluateAbstractCompletion(node, strictCode);
        var context = realm.getRunningContext();
        var savedCompletion = context.savedCompletion;
        if (savedCompletion !== undefined) {
          context.savedCompletion = undefined;
          if (res instanceof _index2.Value) res = (0, _index4.updatePossiblyNormalCompletionWithValue)(realm, savedCompletion, res);else if (res instanceof _completions.PossiblyNormalCompletion) res = (0, _index4.composePossiblyNormalCompletions)(realm, savedCompletion, res);else {
            (0, _invariant2.default)(res instanceof _completions.AbruptCompletion);
            var e = realm.getCapturedEffects();
            (0, _invariant2.default)(e !== undefined);
            realm.stopEffectCaptureAndUndoEffects();
            (0, _invariant2.default)(context.savedCompletion !== undefined);
            e[0] = res;
            var joined_effects = (0, _index4.joinPossiblyNormalCompletionWithAbruptCompletion)(realm, savedCompletion, res, e);
        ...
        (0, _invariant2.default)(!(res instanceof _environment.Reference));
        if (!(res instanceof _index2.EmptyValue)) {
          if (blockValue === undefined || blockValue instanceof _index2.Value) {
            if (res instanceof _completions.AbruptCompletion) throw (0, _index4.UpdateEmpty)(realm, res, blockValue || realm.intrinsics.empty);
            (0, _invariant2.default)(res instanceof _completions.NormalCompletion || res instanceof _index2.Value);
            blockValue = res;
          } else {
            (0, _invariant2.default)(blockValue instanceof _completions.PossiblyNormalCompletion);
            if (res instanceof _completions.AbruptCompletion) {
              throw (0, _index4.stopEffectCaptureAndJoinCompletions)(blockValue, res, realm);
            } else {
              if (res instanceof _index2.Value) blockValue.value = res;else {
                (0, _invariant2.default)(blockValue instanceof _completions.PossiblyNormalCompletion);
                (0, _invariant2.default)(res instanceof _completions.PossiblyNormalCompletion);
                blockValue = (0, _index4.composePossiblyNormalCompletions)(realm, blockValue, res);
              }
            }
          }
        }
...
function PartiallyEvaluateStatements(body, blockValue, strictCode, blockEnv, realm) {
  var statementAsts = [];
  ...
  try {
    for (var _iterator20 = body[Symbol.iterator](), _step20; !(_iteratorNormalCompletion20 = (_step20 = _iterator20.next()).done); _iteratorNormalCompletion20 = true) {
      ...
      if (node.type !== "FunctionDeclaration") {
        ...
        if (!(res instanceof _index2.EmptyValue)) {
          if (blockValue === undefined || blockValue instanceof _index2.Value) {
            if (res instanceof _completions.AbruptCompletion) return [(0, _index4.UpdateEmpty)(realm, res, blockValue || realm.intrinsics.empty), statementAsts];
            (0, _invariant2.default)(res instanceof _completions.NormalCompletion || res instanceof _index2.Value);
            blockValue = res;
          } else {
            (0, _invariant2.default)(blockValue instanceof _completions.PossiblyNormalCompletion);
            if (res instanceof _completions.AbruptCompletion) {
              ...
              (0, _invariant2.default)(blockValue instanceof _completions.PossiblyNormalCompletion);
              e[0] = res;
              var joined_effects = (0, _index4.joinPossiblyNormalCompletionWithAbruptCompletion)(realm, blockValue, res, e);
              realm.applyEffects(joined_effects);
              var jres = joined_effects[0];
              (0, _invariant2.default)(jres instanceof _index2.Value || jres instanceof _completions.Completion);
...
// ECMA262 9.2.5
function FunctionCreate(realm, kind, ParameterList, Body, Scope, Strict, prototype) {
  ...
  var F = FunctionAllocate(realm, prototype, Strict, allocKind);
  ...
  if (!Strict && kind === "normal") {
    (0, _index3.DefinePropertyOrThrow)(realm, F, "arguments", {
...
// ECMA262 18.2.1.2
function EvalDeclarationInstantiation(realm, body, varEnv, lexEnv, strict) {
  ...
  var varDeclarations = FindVarScopedDeclarations(body);
      ...
      try {
        for (var _iterator22 = varNames[Symbol.iterator](), _step22; !(_iteratorNormalCompletion22 = (_step22 = _iterator22.next()).done); _iteratorNormalCompletion22 = true) {
          ...
          if (varEnvRec.HasLexicalDeclaration(name)) {
            throw realm.createErrorThrowCompletion(realm.intrinsics.SyntaxError, new _index2.StringValue(realm, name + " global object is restricted"));
          }
  ...
  try {
    for (var _iterator25 = varDeclarations[Symbol.iterator](), _step25; !(_iteratorNormalCompletion25 = (_step25 = _iterator25.next()).done); _iteratorNormalCompletion25 = true) {
      ...
      if (_d2.type === "VariableDeclaration") {
        ...
        try {
          for (var _iterator30 = (0, _index4.BoundNames)(realm, _d2)[Symbol.iterator](), _step30; !(_iteratorNormalCompletion30 = (_step30 = _iterator30.next()).done); _iteratorNormalCompletion30 = true) {
  ...
  try {
    for (var _iterator27 = lexDeclarations[Symbol.iterator](), _step27; !(_iteratorNormalCompletion27 = (_step27 = _iterator27.next()).done); _iteratorNormalCompletion27 = true) {
      ...
      try {
        for (var _iterator31 = (0, _index4.BoundNames)(realm, _d3)[Symbol.iterator](), _step31; !(_iteratorNormalCompletion31 = (_step31 = _iterator31.next()).done); _iteratorNormalCompletion31 = true) {
...
// ECMA 9.2.10
function MakeMethod(realm, F, homeObject) {
  // Note that F is a new object, and we can thus write to internal slots
  (0, _invariant2.default)(realm.isNewObject(F));

  // 1. Assert: F is an ECMAScript function object.
  (0, _invariant2.default)(F instanceof _index2.ECMAScriptSourceFunctionValue, "F is an ECMAScript function object.");

  // 2. Assert: Type(homeObject) is Object.
  (0, _invariant2.default)(homeObject instanceof _index2.ObjectValue, "Type(homeObject) is Object.");
...
// ECMA 14.3.8
function DefineMethod(realm, prop, obj, env, strictCode, functionPrototype) {
  ...
  var closure = FunctionCreate(realm, kind, prop.params, prop.body, scope, strict, functionPrototype);
