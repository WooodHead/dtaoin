...
exports.default = function (realm) {
  ...
  function parseTypeNameOrTemplate(typeNameOrTemplate) {
    if (typeNameOrTemplate === undefined || typeNameOrTemplate instanceof _index.UndefinedValue) {
      ...
      return {
        type: _type,
        template: _index.Value.isTypeCompatibleWith(_type, _index.ObjectValue) ? (0, _index2.ObjectCreate)(realm, realm.intrinsics.ObjectPrototype) : undefined
      };
    ...
    value: new _index.NativeFunctionValue(realm, "global.__abstract", "__abstract", 0, function (context, _ref) {
      ...
      if (nameString === "") {
        ...
        buildNode = function buildNode() {
          return buildThrowErrorAbstractValue(realm.preludeGenerator)({
            LOCATION: t.stringLiteral(locString || "(unknown location)")
          });
        };
      } else {
        buildNode = (0, _builder2.default)(nameString)(realm.preludeGenerator);
      }
  ...
  global.$DefineOwnProperty("__initializedModules", {
    value: new _index.ObjectValue(realm),
    writable: true,
    enumerable: false,
    configurable: true
  });
  ...
  function deriveNativeFunctionValue(unsafe) {
    return new _index.NativeFunctionValue(realm, "global.__residual", "__residual", 2, function (context, _ref3) {
      ...
      if (template) {
        ...
        template.makePartial();
        (0, _invariant2.default)(realm.generator);
        realm.rebuildNestedProperties(result, result._buildNode.name);
      }
      return result;
    });
  }
  ...
  global.$DefineOwnProperty("__assumeDataProperty", {
    value: new _index.NativeFunctionValue(realm, "global.__assumeDataProperty", "__assumeDataProperty", 3, function (context, _ref11) {
      ...
      if (object instanceof _index.AbstractObjectValue || object instanceof _index.ObjectValue) {
        ...
        var condition = function condition(_ref13) {
          ...
          switch (invariantOptionString) {
            case "VALUE_DEFINED_INVARIANT":
              condition = function condition(_ref15) {
                ...
                return t.binaryExpression("===", t.memberExpression(objectNode, t.identifier(key)), t.valueToNode(undefined));
              };
              break;
            case "SKIP_INVARIANT":
              condition = null;
...
var buildThrowErrorAbstractValue = (0, _builder2.default)("(function(){throw new global.Error('abstract value defined at ' + LOCATION);})()");
