...
exports.default = function (realm) {
  ...
  var setupBufferJS = new _index.NativeFunctionValue(realm, intrinsicName + ".setupBufferJS", "setupBufferJS", 0, function (setupContext, setupArgs) {
    ...
    var _loop = function _loop(name) {
      ...
      (0, _index2.Set)(realm, proto, name, wrapper, true);
    };
    ...
    (0, _index2.Set)(realm, proto, "utf8Slice", utf8Slice, true);
    ...
    (0, _index2.Set)(realm, proto, "copy", copy, true);

    // TODO: Set up more methods on the prototype and bindingObject
    return realm.intrinsics.undefined;
  });
  (0, _index2.Set)(realm, obj, "setupBufferJS", setupBufferJS, true);
  ...
  (0, _index2.Set)(realm, obj, "createFromString", createFromString, true);
  ...
  try {
    for (var _iterator2 = simpleWrapperNames[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      ...
      (0, _index2.Set)(realm, obj, name, wrapper, true);
    }
  } catch (err) {
  ...
  (0, _index2.Set)(realm, obj, "kMaxLength", new _index.NumberValue(realm, nativeBuffer.kMaxLength), true);
  (0, _index2.Set)(realm, obj, "kStringMaxLength", new _index.NumberValue(realm, nativeBuffer.kStringMaxLength), true);
