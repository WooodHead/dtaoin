...
exports.default = function (realm) {
  ...
  function ContextifyScriptConstructor(context, args, argLength, newTarget) {
    ...
    if (cachedDataBuf.length) {
      (0, _index2.Set)(realm, obj, "cachedDataRejected", realm.intrinsics.true, true);
    }

    if (produceCachedData) {
      (0, _index2.Set)(realm, obj, "cachedDataProduced", realm.intrinsics.false, true);
    }
  ...
  (0, _index2.Set)(realm, obj, "ContextifyScript", ContextifyScript, true);
  ...
  function decorateErrorStack(completion) {
    ...
    (0, _index2.Set)(realm, error, "stack", new _index.StringValue(realm, decoratedStack), false);
  ...
  (0, _index2.DefinePropertyOrThrow)(realm, ContextifyScript, "prototype", {
  ...
  (0, _index2.DefinePropertyOrThrow)(realm, ContextifyScriptPrototype, "constructor", {
