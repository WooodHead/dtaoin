...
exports.default = function (realm, processArgv) {
  ...
  (0, _index2.DefinePropertyOrThrow)(realm, obj, "argv0", {
    value: argv0,
    writable: false,
    configurable: true,
    enumerable: true
  ...
  (0, _index2.DefinePropertyOrThrow)(realm, argv, "0", {
    value: argv0,
    writable: true,
    configurable: true,
    enumerable: true
  ...
  (0, _index2.DefinePropertyOrThrow)(realm, argv, "1", {
  ...
  (0, _index2.DefinePropertyOrThrow)(realm, argv, "indexOf", {
  ...
  (0, _index2.DefinePropertyOrThrow)(realm, env, "NODE_NO_WARNINGS", {
  ...
  obj.defineNativeMethod("_setupProcessObject", 1, function (self, _ref) {
    ...
    (0, _index2.OrdinaryDelete)(realm, obj, "_setupProcessObject");
  ...
  obj.defineNativeMethod("_setupPromises", 1, function (self, _ref3) {
    ...
    (0, _index2.OrdinaryDelete)(realm, obj, "_setupPromises");
    return realm.intrinsics.undefined;
  });
  ...
  obj.defineNativeMethod("_setupNextTick", 1, function (self, _ref5) {
    ...
    (0, _index2.OrdinaryDelete)(realm, obj, "_setupNextTick");
    ...
    (0, _index2.OrdinaryDefineOwnProperty)(realm, runMicrotasks, "runMicrotasks", {
    ...
    (0, _index2.OrdinaryDefineOwnProperty)(realm, tickInfo, "0", {
      value: realm.intrinsics.zero,
      writable: true,
      enumerable: true,
      configurable: true
    });
    (0, _index2.OrdinaryDefineOwnProperty)(realm, tickInfo, "1", {
      value: realm.intrinsics.zero,
      writable: true,
      enumerable: true,
      configurable: true
...
function initializeTimerWrap(realm) {
  ...
  (0, _index2.OrdinaryDefineOwnProperty)(realm, obj, "Timer", {
    value: constructor,
    writable: true,
    enumerable: true,
    configurable: true
...
function initializeTTYWrap(realm) {
  ...
  (0, _index2.OrdinaryDefineOwnProperty)(realm, obj, "TTY", {
    value: constructor,
    writable: true,
    enumerable: true,
    configurable: true
  ...
  (0, _index2.DefinePropertyOrThrow)(realm, constructor, "prototype", {
    value: TTYPrototype,
    writable: true,
    enumerable: false,
    configurable: false
  ...
  obj.defineNativeMethod("isTTY", 0, function (context, args) {
    var fd = (0, _index2.ToInteger)(realm, args[0]);
    var types = new _index3.TypesDomain(_index.BooleanValue);
    var values = new _index3.ValuesDomain(new Set([realm.intrinsics.true, realm.intrinsics.false]));
    var buildNode = (0, _builder2.default)("(process.binding('tty_wrap').isTTY(" + fd + "))")(realm.preludeGenerator);
...
function initializeSignalWrap(realm) {
  ...
  (0, _index2.OrdinaryDefineOwnProperty)(realm, obj, "Signal", {
    value: constructor,
    writable: true,
    enumerable: true,
    configurable: true
...
function initializeStreamWrap(realm) {
  ...
  (0, _index2.OrdinaryDefineOwnProperty)(realm, obj, "WriteWrap", {
    value: constructor,
    writable: true,
    enumerable: true,
    configurable: true
  ...
  (0, _index2.DefinePropertyOrThrow)(realm, obj, "ShutdownWrap", {
    value: ShutdownWrap,
    writable: true,
    configurable: true,
    enumerable: true
...
function initializeFSEvent(realm) {
  ...
  (0, _index2.DefinePropertyOrThrow)(realm, obj, "FSEvent", {
    value: FSEvent,
    writable: true,
    configurable: true,
    enumerable: true
...
function createAbstractValue(realm, type, intrinsicName) {
  ...
  var values = type === _index.ObjectValue ? new _index3.ValuesDomain(new Set([new _index.ObjectValue(realm)])) : _index3.ValuesDomain.topVal;
  var buildNode = (0, _builder2.default)(intrinsicName)(realm.preludeGenerator);
...
function createIntrinsicArrayValue(realm, intrinsicName) {
  ...
  (0, _index2.OrdinaryDefineOwnProperty)(realm, obj, "length", {
    value: realm.intrinsics.zero,
    writable: true,
    enumerable: false,
    configurable: false
