...
exports.default = function (realm) {
  ...
  var types = new _index3.TypesDomain(_index.ObjectValue);
  var values = new _index3.ValuesDomain(new Set([new _index.ObjectValue(realm)]));
  var buildNode = (0, _builder2.default)(intrinsicName + ".FSReqWrap")(realm.preludeGenerator);
  var FSReqWrap = realm.createAbstract(types, values, [], buildNode, undefined, intrinsicName + ".FSReqWrap");
  (0, _index2.DefinePropertyOrThrow)(realm, obj, "FSReqWrap", {
    value: FSReqWrap,
    writable: true,
    configurable: true,
    enumerable: true
