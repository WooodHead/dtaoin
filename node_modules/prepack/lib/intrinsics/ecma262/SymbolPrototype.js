...
exports.default = function (realm, obj) {
  ...
  obj.defineNativeMethod("toString", 0, function (context) {
    var target = context instanceof _index.ObjectValue ? context.$SymbolData : context;
    if (target instanceof _index.AbstractValue && target.getType() === _index.SymbolValue) {
      var codeTemplate = "(A).toString()";
      return realm.createAbstract(new _index3.TypesDomain(_index.StringValue), _index3.ValuesDomain.topVal, [target], function (_ref) {
  ...
  // ECMA262 19.4.3.4
  obj.defineNativeMethod(realm.intrinsics.SymbolToPrimitive, 1, function (context, _ref3) {
