...
exports.default = function (realm, obj) {
  ...
  obj.defineNativeMethod("bind", 1, function (context, _ref5) {
    ...
    var F = (0, _function.BoundFunctionCreate)(realm, Target, thisArg, args);
    ...
    (0, _properties.DefinePropertyOrThrow)(realm, F, "length", {
    ...
    (0, _function.SetFunctionName)(realm, F, targetName, "bound");
  ...
  obj.defineNativeMethod("toString", 0, function (context) {
    ...
    if (context instanceof _index.NativeFunctionValue) {
      ...
      return new _index.StringValue(realm, "function () { TODO: provide function source code }");
    } else {
