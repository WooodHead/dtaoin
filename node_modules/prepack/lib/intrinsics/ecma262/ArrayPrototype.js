...
exports.default = function (realm, obj) {
  ...
  obj.defineNativeMethod("concat", 1, function (context, args, argCount) {
    ...
    (0, _index2.Set)(realm, A, "length", new _index.NumberValue(realm, n), true);
  ...
  if (!realm.isCompatibleWith(realm.MOBILE_JSC_VERSION)) obj.defineNativeMethod("copyWithin", 2, function (context, _ref) {
    ...
    while (count > 0) {
      ...
      if (fromPresent === true) {
        ...
        (0, _index2.Set)(realm, O, toKey, fromVal, true);
      } else {
        // e. Else fromPresent is false,
        // i. Perform ? DeletePropertyOrThrow(O, toKey).
        (0, _index2.DeletePropertyOrThrow)(realm, O, toKey);
      }
  ...
  obj.defineNativeMethod("fill", 1, function (context, _ref5) {
    ...
    while (k < final) {
      ...
      (0, _index2.Set)(realm, O, Pk, value, true);
  ...
  obj.defineNativeMethod("pop", 0, function (context) {
    ...
    if (len === 0) {
      ...
      (0, _index2.Set)(realm, O, "length", realm.intrinsics.zero, true);
      ...
      (0, _index2.DeletePropertyOrThrow)(realm, O, indx);

      // e. Perform ? Set(O, "length", newLen, true).
      (0, _index2.Set)(realm, O, "length", new _index.NumberValue(realm, newLen), true);
  ...
  obj.defineNativeMethod("push", 1, function (context, args, argCount) {
    ...
    while (items.length) {
      ...
      (0, _index2.Set)(realm, O, new _index.StringValue(realm, len + ""), E, true);
    ...
    (0, _index2.Set)(realm, O, new _index.StringValue(realm, "length"), new _index.NumberValue(realm, len), true);
  ...
  obj.defineNativeMethod("reverse", 0, function (context) {
    ...
    while (lower !== middle) {
      ...
      if (lowerExists && upperExists) {
        ...
        (0, _index2.Set)(realm, O, lowerP, upperValue, true);

        // ii. Perform ? Set(O, upperP, lowerValue, true).
        (0, _index2.Set)(realm, O, upperP, lowerValue, true);
        ...
        (0, _index2.DeletePropertyOrThrow)(realm, O, upperP);
      } else if (lowerExists && !upperExists) {
        // j. Else if lowerExists is true and upperExists is false, then
        (0, _invariant2.default)(lowerValue, "expected lower value to exist");

        // i. Perform ? DeletePropertyOrThrow(O, lowerP).
        (0, _index2.DeletePropertyOrThrow)(realm, O, lowerP);
  ...
  obj.defineNativeMethod("shift", 0, function (context) {
    ...
    while (k < len) {
      ...
      if (fromPresent) {
        ...
        (0, _index2.Set)(realm, O, to, fromVal, true);
      } else {
        // d. Else fromPresent is false,
        // i. Perform ? DeletePropertyOrThrow(O, to).
        (0, _index2.DeletePropertyOrThrow)(realm, O, to);
      }
    ...
    (0, _index2.DeletePropertyOrThrow)(realm, O, new _index.StringValue(realm, len - 1 + ""));

    // 8. Perform ? Set(O, "length", len-1, true).
    (0, _index2.Set)(realm, O, "length", new _index.NumberValue(realm, len - 1), true);
  ...
  obj.defineNativeMethod("sort", 1, function (context, _ref33) {
    ...
    var isSparse = function isSparse() {
      ...
      for (var i = 0; i < len; i++) {
        ...
        (0, _index2.ThrowIfMightHaveBeenDeleted)(elem.value);
      }
      // 2.Return false.
      return false;
    };
    ...
    if (sparse) {
      ...
      for (var _j = 0; _j < len; _j++) {
        ...
        if (prop !== undefined && !prop.configurable) {
          (0, _index2.ThrowIfMightHaveBeenDeleted)(prop.value);
    ...
    for (var _j2 = 0; _j2 < len; _j2++) {
      ...
      if (_prop !== undefined && !_prop.writable) {
        (0, _index2.ThrowIfMightHaveBeenDeleted)(_prop.value);
    ...
    for (var _j4 = 0; _j4 < len; _j4++) {
      if (arr.hasOwnProperty(_j4.toString())) {
        ...
        (0, _index2.DeletePropertyOrThrow)(realm, O, _j4.toString());
      }
    }
  ...
  obj.defineNativeMethod("splice", 2, function (context, _ref35, argLength) {
    ...
    (0, _index2.Set)(realm, A, "length", new _index.NumberValue(realm, actualDeleteCount), true);
    ...
    if (itemCount < actualDeleteCount) {
      ...
      while (k < len - actualDeleteCount) {
        ...
        if (_fromPresent) {
          ...
          (0, _index2.Set)(realm, O, to, _fromValue, true);
        } else {
      ...
      while (k > len - actualDeleteCount + itemCount) {
        ...
        (0, _index2.DeletePropertyOrThrow)(realm, O, new _index.StringValue(realm, k - 1 + ""));
      ...
      while (k > actualStart) {
        ...
        if (_fromPresent2) {
          ...
          // 2. Perform ? Set(O, to, fromValue, true).
          (0, _index2.Set)(realm, O, _to, _fromValue2, true);
        } else {
          // v. Else fromPresent is false,
          // 1. Perform ? DeletePropertyOrThrow(O, to).
          (0, _index2.DeletePropertyOrThrow)(realm, O, _to);
        }
    ...
    while (items.length) {
      ...
      (0, _index2.Set)(realm, O, new _index.StringValue(realm, k + ""), E, true);
    ...
    (0, _index2.Set)(realm, O, "length", new _index.NumberValue(realm, len - actualDeleteCount + itemCount), true);
  ...
  obj.defineNativeMethod("unshift", 1, function (context, items, argCount) {
    ...
    if (argCount > 0) {
      ...
      while (k > 0) {
        ...
        if (fromPresent) {
          ...
          // 2. Perform ? Set(O, to, fromValue, true).
          (0, _index2.Set)(realm, O, to, fromValue, true);
        } else {
      ...
      while (items.length) {
        ...
        (0, _index2.Set)(realm, O, new _index.StringValue(realm, j + ""), E, true);
    ...
    (0, _index2.Set)(realm, O, "length", new _index.NumberValue(realm, len + argCount), true);
