...
exports.default = function (realm) {
  ...
  var _loop = function _loop(name, length) {
    obj.defineNativeMethod(name, length, function (context, args, originalLength) {
      ...
      if (args.some(function (arg) {
        ...
        if (r === undefined) {
          var _names = [].concat(_toConsumableArray(new Array(args.length))).map(function (_, i) {
            return "X" + i;
          });
          var _f = (0, _builder2.default)("Math." + name + "(" + _names.join(", ") + ")");
          buildMathTemplates.set(name, r = { f: _f, names: _names });
        }

        return realm.createAbstract(new _index3.TypesDomain(_index.NumberValue), _index3.ValuesDomain.topVal, args, function (nodes) {
          (0, _invariant2.default)(r !== undefined);
          var mapping = {};
          for (var i = 0; i < nodes.length; i++) {
            mapping[r.names[i]] = nodes[i];
  ...
  obj.defineNativeMethod("imul", 2, function (context, _ref3) {
    ...
    if ((x instanceof _index.AbstractValue || y instanceof _index.AbstractValue) && (0, _index2.IsToNumberPure)(realm, x) && (0, _index2.IsToNumberPure)(realm, y)) {
      return realm.createAbstract(new _index3.TypesDomain(_index.NumberValue), _index3.ValuesDomain.topVal, [x, y], function (_ref5) {
        var _ref6 = _slicedToArray(_ref5, 2),
            a = _ref6[0],
            b = _ref6[1];

        return buildMathImul(realm.preludeGenerator)({ A: a, B: b });
      });
    }
  ...
  obj.defineNativeMethod("random", 0, function (context) {
    if (realm.mathRandomGenerator !== undefined) {
      ...
      return realm.deriveAbstract(new _index3.TypesDomain(_index.NumberValue), _index3.ValuesDomain.topVal, [], buildMathRandom(realm.preludeGenerator), { isPure: true, skipInvariant: true });
    } else {
...
var buildMathRandom = (0, _builder2.default)("global.Math.random()");
var buildMathImul = (0, _builder2.default)("global.Math.imul(A, B)");
