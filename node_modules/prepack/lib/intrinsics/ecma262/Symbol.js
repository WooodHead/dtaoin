...
exports.default = function (realm) {
  ...
  func.defineNativeMethod("for", 1, function (context, _ref3) {
    ...
    try {
      for (var _iterator = GlobalSymbolRegistry[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var e = _step.value;
  ...
  func.defineNativeMethod("keyFor", 1, function (context, _ref5) {
    ...
    try {
      for (var _iterator2 = GlobalSymbolRegistry[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        var e = _step2.value;
