...
exports.default = function (realm) {
  ...
  function getCurrentTime() {
    if (realm.useAbstractInterpretation) {
      var tmp = realm.deriveAbstract(new _index2.TypesDomain(_index.NumberValue), _index2.ValuesDomain.topVal, [], buildDateNow(realm.preludeGenerator), { isPure: true, skipInvariant: true });
      (0, _invariant2.default)(tmp instanceof _index.AbstractValue, "getCurrentTime() should always return and abstract value");
      return tmp;
    } else {
      var newNow = Date.now();
...
var buildDateNow = (0, _builder2.default)("global.Date.now()");
