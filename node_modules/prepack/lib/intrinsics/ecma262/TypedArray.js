...
exports.default = function (realm) {
  ...
  func.defineNativeMethod("from", 1, function (context, _ref) {
    ...
    if (!(usingIterator instanceof _index.UndefinedValue)) {
      ...
      while (_k < _len) {
        ...
        (0, _properties.Set)(realm, _targetObj, Pk, mappedValue, true);
    ...
    while (k < len) {
      ...
      (0, _properties.Set)(realm, targetObj, _Pk, _mappedValue, true);
  ...
  func.defineNativeMethod("of", 0, function (context, items, argCount) {
    ...
    while (k < len) {
      ...
      (0, _properties.Set)(realm, newObj, Pk, kValue, true);
    ...
    if (argCount === 0) {
      ...
      if (!(usingIterator instanceof _index.UndefinedValue)) {
        ...
        while (_k2 < _len2) {
          ...
          (0, _properties.Set)(realm, _O, Pk, kValue, true);
      ...
      while (k < len) {
        ...
        (0, _properties.Set)(realm, _O, _Pk2, _kValue2, true);
