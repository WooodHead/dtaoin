...
exports.default = function (realm, obj) {
  ...
  obj.defineNativeMethod("toLocaleString", 0, function (context) {
    ...
    if (realm.useAbstractInterpretation) {
      ...
      return realm.deriveAbstract(new _index3.TypesDomain(_index.StringValue), _index3.ValuesDomain.topVal, [x], function (_ref5) {
        var _ref6 = _slicedToArray(_ref5, 1),
            n = _ref6[0];

        return buildToLocaleString(realm.preludeGenerator)({
          VALUE: n
        });
      });
    } else {
  ...
  // ECMA262 20.1.3.5
  obj.defineNativeMethod("toPrecision", 1, function (context, _ref7) {
  ...
  // ECMA262 20.1.3.6
  obj.defineNativeMethod("toString", 1, function (context, _ref9) {
    ...
    if (radix instanceof _index.UndefinedValue) {
      ...
      if (target instanceof _index.AbstractValue && target.getType() === _index.NumberValue) {
        ...
        return realm.createAbstract(new _index3.TypesDomain(_index.StringValue), _index3.ValuesDomain.topVal, [target], function (_ref11) {
...
var buildToLocaleString = (0, _builder2.default)("(VALUE).toLocaleString()");
