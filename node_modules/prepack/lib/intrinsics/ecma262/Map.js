...
exports.default = function (realm) {
  var func = new _index.NativeFunctionValue(realm, "Map", "Map", 0, function (context, _ref, argCount, NewTarget) {
    ...
    var map = (0, _index2.OrdinaryCreateFromConstructor)(realm, NewTarget, "MapPrototype", {
      $MapData: undefined
    });
    ...
    while (true) {
      ...
      if (!(nextItem instanceof _index.ObjectValue) && !(nextItem instanceof _index.AbstractObjectValue)) {
