...
var IntegerIndexedExotic = function (_ObjectValue) {
  ...
  _createClass(IntegerIndexedExotic, [{
    ...
    value: function $GetOwnProperty(P) {
      ...
      return (0, _properties.OrdinaryGetOwnProperty)(this.$Realm, O, P);
    }
    ...
    value: function $DefineOwnProperty(P, Desc) {
      ...
      return (0, _properties.OrdinaryDefineOwnProperty)(this.$Realm, O, P, Desc);
    }
    ...
    value: function $Set(P, V, Receiver) {
      ...
      return (0, _properties.OrdinarySet)(this.$Realm, O, P, V, Receiver);
    }
