  ...
  _createClass(ProxyValue, [{
    ...
    value: function $GetOwnProperty(P) {
      ...
      if (trapResultObj instanceof _index.UndefinedValue) {
        ...
        (0, _properties.ThrowIfMightHaveBeenDeleted)(targetDesc.value);
      ...
      (0, _properties.CompletePropertyDescriptor)(realm, resultDesc);

      // 15. Let valid be IsCompatiblePropertyDescriptor(extensibleTarget, resultDesc, targetDesc).
      var valid = (0, _properties.IsCompatiblePropertyDescriptor)(realm, extensibleTarget, resultDesc, targetDesc);
    ...
    value: function $DefineOwnProperty(P, Desc) {
      ...
      var descObj = (0, _properties.FromPropertyDescriptor)(realm, Desc);
      ...
      if (!targetDesc) {
        ...
        if (!(0, _properties.IsCompatiblePropertyDescriptor)(realm, extensibleTarget, Desc, targetDesc)) {
          throw realm.createErrorThrowCompletion(realm.intrinsics.TypeError);
        }
    ...
    value: function $Get(P, Receiver) {
      ...
      if (targetDesc) {
        ...
        if ((0, _is.IsDataDescriptor)(realm, targetDesc) && targetDesc.configurable === false && targetDesc.writable === false) {
          ...
          if (!(0, _abstract.SameValuePartial)(realm, trapResult, targetDesc.value || realm.intrinsics.undefined)) {
            throw realm.createErrorThrowCompletion(realm.intrinsics.TypeError);
          }
        }
    ...
    value: function $Set(P, V, Receiver) {
      ...
      if (targetDesc) {
        ...
        if ((0, _is.IsDataDescriptor)(realm, targetDesc) && !targetDesc.configurable && !targetDesc.writable) {
          ...
          if (!(0, _abstract.SameValuePartial)(realm, V, targetDesc.value || realm.intrinsics.undefined)) {
            throw realm.createErrorThrowCompletion(realm.intrinsics.TypeError);
          }
        }
    ...
    value: function $OwnPropertyKeys() {
      ...
      try {
        for (var _iterator2 = targetKeys[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          if (desc) (0, _properties.ThrowIfMightHaveBeenDeleted)(desc.value);
