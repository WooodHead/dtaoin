  ...
  _createClass(ArrayValue, [{
    ...
    value: function $DefineOwnProperty(P, Desc) {
      ...
      if (P === "length" || P instanceof _index.StringValue && P.value === "length") {
        ...
        return (0, _properties.ArraySetLength)(this.$Realm, A, Desc);
      } else if ((0, _is.IsArrayIndex)(this.$Realm, P)) {
        // 3. Else if P is an array index, then

        // a. Let oldLenDesc be OrdinaryGetOwnProperty(A, "length").
        var oldLenDesc = (0, _properties.OrdinaryGetOwnProperty)(this.$Realm, A, "length");
        ...
        (0, _properties.ThrowIfMightHaveBeenDeleted)(oldLenDesc.value);
        ...
        var succeeded = (0, _properties.OrdinaryDefineOwnProperty)(this.$Realm, A, P, Desc);
        ...
        if (index >= oldLen) {
          ...
          succeeded = (0, _properties.OrdinaryDefineOwnProperty)(this.$Realm, A, "length", oldLenDesc);
      ...
      return (0, _properties.OrdinaryDefineOwnProperty)(this.$Realm, A, P, Desc);
    }
  }]);
