...
var ObjectValue = function (_ConcreteValue) {
  ...
  function ObjectValue(realm, proto, intrinsicName) {
    ...
    if (realm.useAbstractInterpretation) _this.setupBindings();
  ...
  _createClass(ObjectValue, [{
    ...
    value: function $GetPartial(P, Receiver) {
      ...
      if (this !== Receiver || !this.isSimple() || P.mightNotBeString()) {
        _index2.AbstractValue.reportIntrospectionError(P, "TODO");
        throw new _errors.FatalError();
      }
      // If all else fails, use this expression
      var result = void 0;
      if (this.isPartial()) {
        result = this.$Realm.createAbstract(_index.TypesDomain.topVal, _index.ValuesDomain.topVal, [this, P], function (_ref3) {
      ...
      var _loop = function _loop(key, propertyBinding) {
        var desc = propertyBinding.descriptor;
        if (desc === undefined) return "continue"; // deleted
        (0, _invariant2.default)(desc.value !== undefined); // otherwise this is not simple
        var val = desc.value;
        var cond = _this3.$Realm.createAbstract(new _index.TypesDomain(_index2.BooleanValue), _index.ValuesDomain.topVal, [P], function (_ref7) {
          var _ref8 = _slicedToArray(_ref7, 1),
              x = _ref8[0];

          return t.binaryExpression("===", x, t.stringLiteral(key));
        }, "check for known property");
        result = (0, _index3.joinValuesAsConditional)(_this3.$Realm, cond, val, result);
      };
      ...
      try {
        for (var _iterator4 = this.properties[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          ...
          var _ret = _loop(key, propertyBinding);
    ...
    value: function $SetPartial(P, V, Receiver) {
      ...
      if (desc === undefined) {
        ...
        if (!(V instanceof _index2.UndefinedValue)) {
          ...
          var cond = this.$Realm.createAbstract(new _index.TypesDomain(_index2.BooleanValue), _index.ValuesDomain.topVal, [P, new _index2.StringValue(this.$Realm, "")], function (_ref9) {
        ...
        var _newVal = oldVal;
        if (!(V instanceof _index2.UndefinedValue)) {
          var _cond = this.$Realm.createAbstract(new _index.TypesDomain(_index2.BooleanValue), _index.ValuesDomain.topVal, [P, new _index2.StringValue(this.$Realm, "")], function (_ref11) {
      ...
      var _loop2 = function _loop2(key, propertyBinding) {
        var oldVal = _this4.$Realm.intrinsics.empty;
        ...
        var cond = _this4.$Realm.createAbstract(new _index.TypesDomain(_index2.BooleanValue), _index.ValuesDomain.topVal, [P], function (_ref15) {
          var _ref16 = _slicedToArray(_ref15, 1),
              x = _ref16[0];

          return t.binaryExpression("===", x, t.stringLiteral(key));
        });
        var newVal = (0, _index3.joinValuesAsConditional)(_this4.$Realm, cond, V, oldVal);
        (0, _index3.OrdinarySet)(_this4.$Realm, _this4, key, newVal, Receiver);
      };
    ...
    value: function setupTrackedPropertyAccessors() {
      var _loop3 = function _loop3(propName) {
