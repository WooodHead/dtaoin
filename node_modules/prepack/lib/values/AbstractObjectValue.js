...
var AbstractObjectValue = function (_AbstractValue) {
  ...
  function AbstractObjectValue(realm, types, values, args, buildNode, optionalArgs) {
    _classCallCheck(this, AbstractObjectValue);

    return _possibleConstructorReturn(this, (AbstractObjectValue.__proto__ || Object.getPrototypeOf(AbstractObjectValue)).call(this, realm, types, values, args, buildNode, optionalArgs));
  }

  _createClass(AbstractObjectValue, [{
    key: "clone",
    value: function clone() {
      var result = new AbstractObjectValue(this.$Realm, this.types, this.values, this.args, this._buildNode);
    ...
    value: function getTemplate() {
      ...
      try {
        for (var _iterator = this.values.getElements()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          for (var _iterator8 = elements[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
            ...
            if (d === undefined) doesNotHaveProp = true;else {
              ...
              if (desc === undefined) {
                ...
                var cond = this.$Realm.createAbstract(new _index2.TypesDomain(_index.BooleanValue), _index2.ValuesDomain.topVal, [this, _cv], function (_ref) {
                ...
                desc.value = (0, _index3.joinValuesAsConditional)(this.$Realm, cond, d.value, desc.value);
              }
            }
          }
        } catch (err) {
      ...
      if (elements.size === 1) {
        ...
        try {
          for (var _iterator10 = elements[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
            ...
            var cond = this.$Realm.createAbstract(new _index2.TypesDomain(_index.BooleanValue), _index2.ValuesDomain.topVal, [this, _cv2], function (_ref3) {
            ...
            desc.value = (0, _index3.joinValuesAsConditional)(this.$Realm, cond, new_val, dval);
        ...
        try {
          for (var _iterator13 = elements[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
            ...
            if (cv.isSimple() && typeof P === "string") {
              var _ret = function () {
                var generator = _this2.$Realm.generator;
                (0, _invariant2.default)(generator !== undefined);
                var pname = generator.getAsPropertyNameExpression(P);
                var d = cv.$GetOwnProperty(P);
                if (d === undefined) {
                  return {
                    v: _this2.$Realm.deriveAbstract(_index2.TypesDomain.topVal, _index2.ValuesDomain.topVal, [cv], function (_ref5) {
        ...
        try {
          for (var _iterator14 = elements[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
            ...
            if (result === undefined) result = cvVal;else {
              var cond = this.$Realm.createAbstract(new _index2.TypesDomain(_index.BooleanValue), _index2.ValuesDomain.topVal, [this, _cv4], function (_ref7) {
              ...
              result = (0, _index3.joinValuesAsConditional)(this.$Realm, cond, cvVal, result);
            }
          }
        } catch (err) {
    ...
    value: function $GetPartial(P, Receiver) {
      ...
      (0, _invariant2.default)(this === Receiver, "TODO");
      ...
      if (elements.size === 1) {
        ...
        try {
          for (var _iterator16 = elements[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
            ...
            if (result === undefined) result = cvVal;else {
              var cond = this.$Realm.createAbstract(new _index2.TypesDomain(_index.BooleanValue), _index2.ValuesDomain.topVal, [this, _cv5], function (_ref9) {
      ...
      if (elements.size === 1) {
        ...
        try {
          for (var _iterator18 = elements[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
            ...
            var cond = this.$Realm.createAbstract(new _index2.TypesDomain(_index.BooleanValue), _index2.ValuesDomain.topVal, [this, _cv6], function (_ref11) {
            ...
            var v = (0, _index3.joinValuesAsConditional)(this.$Realm, cond, V, oldVal);
      ...
      if (elements.size === 1) {
        ...
        try {
          for (var _iterator20 = elements[Symbol.iterator](), _step20; !(_iteratorNormalCompletion20 = (_step20 = _iterator20.next()).done); _iteratorNormalCompletion20 = true) {
            ...
            var cond = this.$Realm.createAbstract(new _index2.TypesDomain(_index.BooleanValue), _index2.ValuesDomain.topVal, [this, _cv7], function (_ref13) {
      ...
      if (elements.size === 1) {
        ...
        try {
          for (var _iterator22 = elements[Symbol.iterator](), _step22; !(_iteratorNormalCompletion22 = (_step22 = _iterator22.next()).done); _iteratorNormalCompletion22 = true) {
            ...
            var cond = this.$Realm.createAbstract(new _index2.TypesDomain(_index.BooleanValue), _index2.ValuesDomain.topVal, [this, _cv8], function (_ref15) {
            ...
            var v = (0, _index3.joinValuesAsConditional)(this.$Realm, cond, this.$Realm.intrinsics.empty, d.value);
