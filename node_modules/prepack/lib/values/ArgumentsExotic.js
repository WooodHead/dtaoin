...
var ArgumentsExotic = function (_ObjectValue) {
  ...
  _createClass(ArgumentsExotic, [{
    ...
    value: function $GetOwnProperty(P) {
      ...
      var desc = (0, _properties.OrdinaryGetOwnProperty)(this.$Realm, args, P);

      // 3. If desc is undefined, return desc.
      if (desc === undefined) return undefined;
      (0, _properties.ThrowIfMightHaveBeenDeleted)(desc.value);
    ...
    value: function $DefineOwnProperty(P, Desc) {
      ...
      var allowed = (0, _properties.OrdinaryDefineOwnProperty)(this.$Realm, args, P, newArgDesc);
      ...
      if (isMapped === true) {
        ...
        if ((0, _is.IsAccessorDescriptor)(this.$Realm, Desc) === true) {
          ...
          if (Desc.value !== undefined) {
            ...
            var setStatus = (0, _properties.Set)(this.$Realm, map, P, Desc.value, false);
    ...
    value: function $Set(P, V, Receiver) {
      ...
      if (isMapped === true) {
        ...
        var setStatus = (0, _properties.Set)(this.$Realm, map, P, V, false);
      ...
      return (0, _properties.OrdinarySet)(this.$Realm, args, P, V, Receiver);
    }
    ...
    value: function $Delete(P) {
      ...
      var result = (0, _properties.OrdinaryDelete)(this.$Realm, args, P);
