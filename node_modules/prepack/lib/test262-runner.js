...
function usage() {
  return "Usage: " + process.argv[0] + " " + process.argv[1] + " " + EOL + "[--verbose] [--timeout <number>] [--bailAfter <number>] " + EOL + "[--cpuScale <number>] [--statusFile <string>] [--singleThreaded] [--relativeTestPath <string>]";
}

function masterArgsParse() {
  var parsedArgs = (0, _minimist2.default)(process.argv.slice(2), {
  ...
  process.on("message", function (message) {
    switch (message.type) {
      ...
      case QuitMessage.sentinel:
        ...
        break;
      default:
        throw new Error("Worker #" + process.pid + " got an unexpected message:\n          " + JSON.stringify(message));
    }
  });
}
