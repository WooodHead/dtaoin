...
function convert(realm, val) {
  if (typeof val === "number") {
    ...
    return (0, _index2.CreateArrayFromList)(realm, val.map(function (item) {
    ...
    throw new _errors.FatalError("TODO: need to convert value of type " + (typeof val === "undefined" ? "undefined" : _typeof(val)));
  }
}
