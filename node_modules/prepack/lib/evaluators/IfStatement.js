...
function evaluateWithAbstractConditional(condValue, consequent, alternate, strictCode, env, realm) {
  ...
  var _realm$evaluateNodeFo = realm.evaluateNodeForEffects(consequent, strictCode, env),
      _realm$evaluateNodeFo2 = _slicedToArray(_realm$evaluateNodeFo, 5),
      compl1 = _realm$evaluateNodeFo2[0],
      gen1 = _realm$evaluateNodeFo2[1],
      bindings1 = _realm$evaluateNodeFo2[2],
      properties1 = _realm$evaluateNodeFo2[3],
      createdObj1 = _realm$evaluateNodeFo2[4];

  var _ref = alternate ? realm.evaluateNodeForEffects(alternate, strictCode, env) : (0, _realm.construct_empty_effects)(realm),
  ...
  (0, _invariant2.default)(completion instanceof _completions.NormalCompletion || completion instanceof _index.Value);
  return completion;
}
