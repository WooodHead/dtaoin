...
exports.default = function (ast, strictCode, env, realm, thrownValue) {
  ...
  var catchEnv = (0, _index2.NewDeclarativeEnvironment)(realm, oldEnv);
  ...
  try {
    for (var _iterator = (0, _index2.BoundNames)(realm, ast.param)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
  ...
  try {
    ...
    (0, _index2.BindingInitialization)(realm, ast.param, thrownValue.value, strictCode, catchEnv);
