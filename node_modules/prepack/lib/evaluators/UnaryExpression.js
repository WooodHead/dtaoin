...
exports.default = function (ast, strictCode, env, realm) {
  ...
  if (ast.operator === "+") {
    ...
    if (value instanceof _index.AbstractValue) {
      if (!(0, _index3.IsToNumberPure)(realm, value)) reportError();
      return computeAbstractly(realm, _index.NumberValue, "+", value);
    }
    (0, _invariant2.default)(value instanceof _index.ConcreteValue);

    return new _index.NumberValue(realm, (0, _index3.ToNumber)(realm, value));
    ...
    if (_value instanceof _index.AbstractValue) {
      if (!(0, _index3.IsToNumberPure)(realm, _value)) reportError();
      return computeAbstractly(realm, _index.NumberValue, "-", _value);
    }
    (0, _invariant2.default)(_value instanceof _index.ConcreteValue);
    var oldValue = (0, _index3.ToNumber)(realm, _value);
    ...
    if (_value2 instanceof _index.AbstractValue) {
      if (!(0, _index3.IsToNumberPure)(realm, _value2)) reportError();
      return computeAbstractly(realm, _index.NumberValue, "~", _value2);
    }
    (0, _invariant2.default)(_value2 instanceof _index.ConcreteValue);
    var _oldValue = (0, _index3.ToInt32)(realm, _value2);
    ...
    if (_value3 instanceof _index.AbstractValue) {
      if (!_value3.mightNotBeTrue()) return realm.intrinsics.false;
      if (!_value3.mightNotBeFalse()) return realm.intrinsics.true;
      return computeAbstractly(realm, _index.BooleanValue, "!", _value3);
    }
    (0, _invariant2.default)(_value3 instanceof _index.ConcreteValue);
    var _oldValue2 = (0, _index3.ToBoolean)(realm, _value3);
    ...
    if ((0, _index3.IsPropertyReference)(realm, ref)) {
      ...
      var baseObj = base instanceof _index.ConcreteValue ? (0, _index3.ToObject)(realm, base) : base;
