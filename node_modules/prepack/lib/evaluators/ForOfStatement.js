...
function BindingInstantiation(realm, ast, env) {
  ...
  try {
    for (var _iterator = (0, _index2.BoundNames)(realm, ast)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
function ForInOfHeadEvaluation(realm, env, TDZnames, expr, iterationKind, strictCode) {
  ...
  if (iterationKind === "enumerate") {
    ...
    if (obj instanceof _index.AbstractValue) {
      return obj;
    } else {
    ...
    try {
      if (!destructuring) {
        ...
        if (lhsKind === "assignment") {
          ...
          status = (0, _index2.BindingInitialization)(realm, lhs, nextValue, strictCode, undefined);
        } else {
          // iii. Else,
          ...
          status = (0, _index2.BindingInitialization)(realm, lhs, nextValue, strictCode, iterationEnv);
        }
      }
    } catch (e) {
