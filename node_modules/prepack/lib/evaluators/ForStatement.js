...
exports.default = function (ast, strictCode, env, realm, labelSet) {
  ...
  if (init && init.type === "VariableDeclaration") {
    if (init.kind === "var") {
      ...
      var loopEnv = (0, _index2.NewDeclarativeEnvironment)(realm, oldEnv);
      ...
      var boundNames = (0, _index2.BoundNames)(realm, init);
    ...
    if (init) {
      ...
      (0, _index2.GetValue)(realm, exprRef);
    }
...
function CreatePerIterationEnvironment(realm, perIterationBindings) {
  ...
  if (perIterationBindings.length > 0) {
    ...
    var thisIterationEnv = (0, _index2.NewDeclarativeEnvironment)(realm, outer);
...
function ForBodyEvaluation(realm, test, increment, stmt, perIterationBindings, labelSet, strictCode) {
  ...
  while (true) {
    ...
    if (test) {
      ...
      var testValue = (0, _index2.GetValue)(realm, testRef);
    ...
    if (increment) {
      ...
      (0, _index2.GetValue)(realm, incRef);
    }
  }
