...
exports.default = function (ast, strictCode, env, realm, labelSet) {
  ...
  var switchValue = (0, _index2.GetValue)(realm, exprRef);
  ...
  (0, _index2.BlockDeclarationInstantiation)(realm, strictCode, CaseBlock, blockEnv);
...
function CaseSelectorEvaluation(expression, strictCode, env, realm) {
  ...
  return (0, _index2.GetValue)(realm, exprRef);
}
