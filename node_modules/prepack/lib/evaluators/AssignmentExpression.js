...
exports.default = function (ast, strictCode, env, realm) {
  ...
  if (AssignmentOperator === "=") {
    ...
    if (LeftHandSideExpression.type !== "ObjectPattern" && LeftHandSideExpression.type !== "ArrayPattern") {
      ...
      var _rval2 = (0, _index2.GetValue)(realm, _rref2);
      ...
      if ((0, _index2.IsAnonymousFunctionDefinition)(realm, AssignmentExpression) && (0, _index2.IsIdentifierRef)(realm, LeftHandSideExpression)) {
        ...
        if (!hasNameProperty) {
          ...
          (0, _index2.SetFunctionName)(realm, _rval2, (0, _index2.GetReferencedName)(realm, _lref));
        }
      }
      // f. Perform ? PutValue(lref, rval).
      (0, _index2.PutValue)(realm, _lref, _rval2);
      // g. Return rval.
      return _rval2;
    }
  ...
  var r = (0, _index2.GetValue)(realm, (0, _BinaryExpression.computeBinary)(realm, op, lval, rval, ast.left.loc, ast.right.loc));
