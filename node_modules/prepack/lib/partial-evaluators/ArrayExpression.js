...
exports.default = function (ast, strictCode, env, realm) {
  ...
  for (var i = 0; i < len; i++) {
    ...
    if (elemValue instanceof _completions.AbruptCompletion) {
      ...
      _index3.AbstractValue.reportIntrospectionError(elemValue.value);
      throw new _errors.FatalError();
    }
    (0, _invariant2.default)(elemValue instanceof _index3.Value);
    ...
    if (elem.type === "SpreadElement") {
      ...
      if (spreadObj instanceof _index3.ObjectValue && !spreadObj.isPartial()) {
        ...
        while (true) {
          ...
          var status = (0, _index2.CreateDataProperty)(realm, array, new _index3.StringValue(realm, nextIndex + ""), nextValue);
        ...
        if (spreadObj instanceof _index3.AbstractValue && spreadObj.getType() === "Array") {
          var method = (0, _index2.GetMethod)(realm, spreadObj, realm.intrinsics.SymbolIterator);
        ...
        _index3.AbstractValue.reportIntrospectionError(spreadObj);
        throw new _errors.FatalError();
      }
      ...
      var abstractIndex = realm.createAbstract(new _index.TypesDomain(_index3.NumberValue), _index.ValuesDomain.topVal, [], t.identifier("never used"));
      ...
      var created = (0, _index2.CreateDataProperty)(realm, array, new _index3.StringValue(realm, nextIndex++ + ""), initValue);
  ...
  (0, _index2.Set)(realm, array, "length", new _index3.NumberValue(realm, nextIndex), false);
