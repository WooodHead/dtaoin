...
exports.default = function (ast, strictCode, env, realm) {
  ...
  (0, _invariant2.default)(ref instanceof _index3.Value || ref instanceof _environment.Reference);
  ...
  try {
    for (var _iterator = ast.arguments[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      if (argValue instanceof _completions.AbruptCompletion) {
        if (completion instanceof _completions.PossiblyNormalCompletion) completion = (0, _index2.stopEffectCaptureAndJoinCompletions)(completion, argValue, realm);else completion = argValue;
      ...
      if (argValue instanceof _completions.PossiblyNormalCompletion) {
        ...
        if (completion instanceof _completions.PossiblyNormalCompletion) completion = (0, _index2.composeNormalCompletions)(completion, argValue, argValue.value, realm);else completion = argValue;
      } else {
        (0, _invariant2.default)(argValue instanceof _index3.Value);
  ...
  if (savedCompletion !== undefined) {
    if (completion instanceof _index3.Value) {
      (0, _index2.updatePossiblyNormalCompletionWithValue)(realm, savedCompletion, completion);
      completion = savedCompletion;
    } else if (completion instanceof _completions.PossiblyNormalCompletion) {
      completion = (0, _index2.composePossiblyNormalCompletions)(realm, savedCompletion, completion);
    } else {
      (0, _invariant2.default)(completion === undefined);
      completion = savedCompletion;
    }
    context.savedCompletion = undefined;
  }
  if (callResult instanceof _completions.AbruptCompletion) {
    if (completion instanceof _completions.PossiblyNormalCompletion) completion = (0, _index2.stopEffectCaptureAndJoinCompletions)(completion, callResult, realm);else completion = callResult;
    var resultAst = t.callExpression(calleeAst, partialArgs);
    return [completion, resultAst, io];
  }
  var callCompletion = void 0;

  var _unbundleNormalComple = (0, _index2.unbundleNormalCompletion)(callResult);

  var _unbundleNormalComple2 = _slicedToArray(_unbundleNormalComple, 2);

  callCompletion = _unbundleNormalComple2[0];
  callResult = _unbundleNormalComple2[1];

  (0, _invariant2.default)(callResult instanceof _index3.Value);
  (0, _invariant2.default)(completion === undefined || completion instanceof _completions.PossiblyNormalCompletion);
  completion = (0, _index2.composeNormalCompletions)(completion, callCompletion, callResult, realm);
...
function callBothFunctionsAndJoinTheirEffects(funcs, ast, argVals, strictCode, env, realm) {
  ...
  (0, _invariant2.default)(cond instanceof _index3.AbstractValue && cond.getType() === _index3.BooleanValue);
  (0, _invariant2.default)(_index3.Value.isTypeCompatibleWith(func1.getType(), _index3.FunctionValue));
  (0, _invariant2.default)(_index3.Value.isTypeCompatibleWith(func2.getType(), _index3.FunctionValue));
  ...
  var joinedEffects = (0, _index2.joinEffects)(realm, cond, [compl1, gen1, bindings1, properties1, createdObj1], [compl2, gen2, bindings2, properties2, createdObj2]);
  ...
  (0, _invariant2.default)(joinedCompletion instanceof _completions.Completion || joinedCompletion instanceof _index3.Value);
  return joinedCompletion;
}

function EvaluateCall(ref, func, ast, argList, strictCode, env, realm) {
  if (func instanceof _index3.AbstractValue && _index3.Value.isTypeCompatibleWith(func.getType(), _index3.FunctionValue)) {
    ...
    return realm.createAbstract(_index.TypesDomain.topVal, _index.ValuesDomain.topVal, [], t.identifier("never used"));
  }
  ...
  if (ref instanceof _environment.Reference && !(0, _index2.IsPropertyReference)(realm, ref) && (0, _index2.GetReferencedName)(realm, ref) === "eval") {
    ...
    if ((0, _index2.SameValue)(realm, func, realm.intrinsics.eval)) {
      ...
      return (0, _index2.PerformEval)(realm, evalText, evalRealm, strictCaller, true);
    }
  }
  ...
  try {
    return (0, _index2.EvaluateDirectCallWithArgList)(realm, strictCode, env, ref, func, thisValue, argList, tailCall);
  } catch (err) {
