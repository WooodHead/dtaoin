...
var ModuleEnvironmentRecord = exports.ModuleEnvironmentRecord = function (_DeclarativeEnvironme2) {
  ...
  _createClass(ModuleEnvironmentRecord, [{
    ...
    // ECMA262 8.1.1.3.1
    value: function BindThisValue(V) {
      throw new _errors.FatalError("TODO: implement modules");
    }
...
var LexicalEnvironment = exports.LexicalEnvironment = function () {
  ...
  _createClass(LexicalEnvironment, [{
    ...
    value: function assignToGlobal(globalAst, rvalue) {
      ...
      (0, _index2.PutValue)(this.realm, globalValue, rvalue);
    }
  }, {
    ...
    value: function partiallyEvaluateCompletionDeref(ast, strictCode, metadata) {
      ...
      if (result instanceof Reference) {
        result = (0, _index2.GetValue)(this.realm, result);
      }
    ...
    value: function evaluateCompletionDeref(ast, strictCode, metadata) {
      ...
      if (result instanceof Reference) result = (0, _index2.GetValue)(this.realm, result);
      return result;
    }
  }, {
    ...
    value: function evaluateCompletion(ast, strictCode, metadata) {
      try {
        ...
        if (err instanceof _completions.JoinedAbruptCompletions || err instanceof _completions.PossiblyNormalCompletion) {
    ...
    value: function executeSources(sources) {
      ...
      var _concatenateAndParse = this.concatenateAndParse(sources, sourceType),
          _concatenateAndParse2 = _slicedToArray(_concatenateAndParse, 2),
      ...
      return [(0, _index2.GetValue)(this.realm, res), code];
    }
  }, {
    ...
    value: function evaluate(ast, strictCode, metadata) {
      ...
      if (res instanceof _completions.PossiblyNormalCompletion) {
        _index.AbstractValue.reportIntrospectionError(res.joinCondition);
        throw new _errors.FatalError();
      }
    ...
    value: function evaluateAbstract(ast, strictCode, metadata) {
      ...
      if (evaluator) {
        ...
        var context = this.realm.getRunningContext();
        var savedCompletion = context.savedCompletion;
        if (savedCompletion !== undefined) {
          if (result instanceof _index.Value) {
            (0, _index2.updatePossiblyNormalCompletionWithValue)(this.realm, savedCompletion, result);
            result = savedCompletion;
          } else if (result instanceof _completions.PossiblyNormalCompletion) {
            result = (0, _index2.composePossiblyNormalCompletions)(this.realm, savedCompletion, result);
          } else {
            _index.AbstractValue.reportIntrospectionError(savedCompletion.joinCondition);
            throw new _errors.FatalError();
          }
