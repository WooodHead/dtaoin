...
var Modules = exports.Modules = function () {
  ...
  _createClass(Modules, [{
    ...
    value: function resolveInitializedModules() {
      ...
      try {
        for (var _iterator2 = globalInitializedModulesMap.getOwnPropertyKeysArray()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          (0, _invariant2.default)(moduleValue);
      ...
      return downgradeErrorsToWarnings(realm, function () {
        try {
          ...
          if (result instanceof _completions.Completion) {
            ...
            _this3.logger.logCompletion(result);
            return undefined;
          }

          if (result instanceof _index2.Value) _this3.recordModuleInitialized(moduleId, result);
          return effects;
        } catch (err) {
    ...
    value: function isModuleInitialized(moduleId) {
      ...
      try {
        ...
        if (generator.body.length !== 0 || compl instanceof _index2.ObjectValue && createdObjects.has(compl)) return undefined;
