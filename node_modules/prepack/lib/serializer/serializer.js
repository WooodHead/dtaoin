...
var Serializer = exports.Serializer = function () {
  ...
  _createClass(Serializer, [{
    ...
    value: function init(sources) {
      ...
      var residualHeapVisitor = new _ResidualHeapVisitor.ResidualHeapVisitor(this.realm, this.logger, this.modules);
      ...
      var residualHeapSerializer = new _ResidualHeapSerializer.ResidualHeapSerializer(this.realm, this.logger, this.modules, residualHeapValueIdentifiers, residualHeapVisitor.inspector, residualHeapVisitor.values, residualHeapVisitor.functionBindings, residualHeapVisitor.functionInfos, !!this.options.delayInitializations, residualHeapVisitor.referencedDeclaredValues);
