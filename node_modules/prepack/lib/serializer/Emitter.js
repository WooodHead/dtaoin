...
var Emitter = exports.Emitter = function () {
  ...
  _createClass(Emitter, [{
    ...
    value: function beginEmitting(dependency, targetBody) {
      ...
      if (dependency instanceof _index.Value) this._activeValues.add(dependency);else if (dependency instanceof _generator.Generator) this._activeBodies.add(targetBody);
    ...
    value: function endEmitting(dependency, oldBody) {
      ...
      if (dependency instanceof _index.Value) {
        ...
        (0, _invariant2.default)(this._activeBodies.has(this._body));
    ...
    value: function finalize() {
      (0, _invariant2.default)(!this._finalized);
      (0, _invariant2.default)(this._activeBodies.size === 1);
      (0, _invariant2.default)(this._activeBodies.has(this._body));
      this._activeBodies.delete(this._body);
      this._processCurrentBody();
      ...
      (0, _invariant2.default)(this._activeBodies.size === 0);
    }
  }, {
    ...
    value: function _processValue(value) {
      ...
      while (a.length > 0) {
        ...
        if (_body !== oldBody) {
          (0, _invariant2.default)(this._activeBodies.has(_body));
          var b = this._waitingForBodies.get(_body);
          if (b === undefined) this._waitingForBodies.set(_body, b = []);
          b.push({ dependencies: _dependencies2, func: _func2 });
        } else {
          this.emitNowOrAfterWaitingForDependencies(_dependencies2, _func2);
        }
      }
    ...
    value: function emitAfterWaiting(reason, dependencies, func) {
      (0, _invariant2.default)(!this._finalized);
      ...
      a.push({ body: this._body, dependencies: dependencies, func: func });
    }
  }, {
    key: "emitNowOrAfterWaitingForDependencies",
    value: function emitNowOrAfterWaitingForDependencies(dependencies, func) {
      (0, _invariant2.default)(!this._finalized);
      var delayReason = this.getReasonToWaitForDependencies(dependencies);
      if (delayReason) {
    ...
    value: function getBodyReference() {
      (0, _invariant2.default)(!this._finalized);
      return new _types.BodyReference(this._body, this._body.length);
    }
  }]);
