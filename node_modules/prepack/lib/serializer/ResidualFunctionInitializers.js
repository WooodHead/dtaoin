...
var ResidualFunctionInitializers = exports.ResidualFunctionInitializers = function () {
  ...
  _createClass(ResidualFunctionInitializers, [{
    ...
    value: function registerValueOnlyReferencedByResidualFunctions(functionValues, val) {
      ...
      if (initializer === undefined) this.initializers.set(id, initializer = { id: id, order: infos.length, values: [], body: [] });
    ...
    value: function getInitializerStatement(functionValue) {
      ...
      try {
        for (var _iterator7 = initializerInfo.initializerIds[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
          var initializerId = _step7.value;

          var initializer = this.initializers.get(initializerId);
          (0, _invariant2.default)(initializer !== undefined);
          (0, _invariant2.default)(initializer.body.length > 0);
      ...
      try {
        for (var _iterator8 = initializers[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
          ...
          if (initializer === ownInitializer) {
            ...
            if (ast === undefined) {
              (function () {
                ast = _this._conditionalInitialization(initializer.values, initializer.body);
